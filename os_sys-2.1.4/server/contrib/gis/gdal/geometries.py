"""
 ...
 Example:
  >>> from server.contrib.gis.gdal import OGRGeometry, OGRGeomType, SpatialReference
...
from server.contrib.gis.gdal.base import GDALBase
from server.contrib.gis.gdal.envelope import Envelope, OGREnvelope
from server.contrib.gis.gdal.error import GDALException, SRSException
from server.contrib.gis.gdal.geomtype import OGRGeomType
from server.contrib.gis.gdal.libgdal import GDAL_VERSION
from server.contrib.gis.gdal.prototypes import geom as capi, srs as srs_api
from server.contrib.gis.gdal.srs import CoordTransform, SpatialReference
from server.contrib.gis.geometry import hex_regex, json_regex, wkt_regex
...
class Point(OGRGeometry):
    ...
    def _geos_ptr(self):
        from server.contrib.gis import geos
