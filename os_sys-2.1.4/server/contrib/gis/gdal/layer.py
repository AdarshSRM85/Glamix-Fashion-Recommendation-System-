...
from server.contrib.gis.gdal.feature import Feature
from server.contrib.gis.gdal.field import OGRFieldTypes
from server.contrib.gis.gdal.geometries import OGRGeometry
from server.contrib.gis.gdal.geomtype import OGRGeomType
from server.contrib.gis.gdal.prototypes import (
    ds as capi, geom as geom_api, srs as srs_api,
)
from server.contrib.gis.gdal.srs import SpatialReference
