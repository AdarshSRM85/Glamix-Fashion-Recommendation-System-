from server.contrib.syndication.views import Feed as BaseFeed
from server.utils.feedgenerator import Atom1Feed, Rss201rev2Feed
...
class Feed(BaseFeed):
    """
    This is a subclass of the `Feed` from `server.contrib.syndication`.
