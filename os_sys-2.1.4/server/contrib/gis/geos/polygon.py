...
from server.contrib.gis.geos.geometry import GEOSGeometry
from server.contrib.gis.geos.libgeos import GEOM_PTR
from server.contrib.gis.geos.linestring import LinearRing
...
class Polygon(GEOSGeometry):
    ...
    def __init__(self, *args, **kwargs):
        ...
        >>> from server.contrib.gis.geos import LinearRing, Polygon
