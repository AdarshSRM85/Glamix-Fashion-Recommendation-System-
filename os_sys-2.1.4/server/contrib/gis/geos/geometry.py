...
from server.contrib.gis.geos import prototypes as capi
from server.contrib.gis.geos.base import GEOSBase
from server.contrib.gis.geos.coordseq import GEOSCoordSeq
from server.contrib.gis.geos.error import GEOSException
from server.contrib.gis.geos.libgeos import GEOM_PTR
from server.contrib.gis.geos.mutable_list import ListMixin
from server.contrib.gis.geos.prepared import PreparedGeometry
from server.contrib.gis.geos.prototypes.io import (
    ewkb_w, wkb_r, wkb_w, wkt_r, wkt_w,
)
from server.utils.deconstruct import deconstructible
...
class GEOSGeometryBase(GEOSBase):
    ...
    def __deepcopy__(self, memodict):
        """
        The `deepcopy` routine is used by the `Node` class of server.utils.tree;
