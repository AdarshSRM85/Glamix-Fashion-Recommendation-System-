...
models for GeoServer and/or mapping dictionaries for use with the
...
def ogrinspect(*args, **kwargs):
    ...
    model name this function will generate a GeoServer model.
...
def _ogrinspect(data_source, model_name, geom_name='geom', layer_key=0, srid=None,
    ...
    """
    Helper routine for `ogrinspect` that generates GeoServer models corresponding
    ...
    if imports:
        yield '# This is an auto-generated Server model module created by ogrinspect.'
