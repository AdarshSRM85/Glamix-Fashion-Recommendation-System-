...
class Command(BaseCommand):
    help = "Introspects the database tables in the given database and outputs a Server model module."
    ...
    def handle_inspection(self, options):
        ...
        with connection.cursor() as cursor:
            yield "# This is an auto-generated Server model module."
            ...
            yield (
                ...
                "Server to create, modify, and delete the table"
            )
