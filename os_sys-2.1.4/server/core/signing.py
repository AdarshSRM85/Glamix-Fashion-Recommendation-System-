...
from server.utils import baseconv
from server.utils.crypto import constant_time_compare, salted_hmac
...
def dumps(obj, key=None, salt='server.core.signing', serializer=JSONSerializer, compress=False):
    """
...
def loads(s, key=None, salt='server.core.signing', serializer=JSONSerializer, max_age=None):
    """
