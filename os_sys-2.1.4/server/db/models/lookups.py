...
from server.db.models.fields import DateTimeField, Field, IntegerField
from server.db.models.query_utils import RegisterLookupMixin
...
class Lookup:
    ...
    def __init__(self, lhs, rhs):
        ...
        if bilateral_transforms:
            ...
            from server.db.models.sql.query import Query  # avoid circular import
