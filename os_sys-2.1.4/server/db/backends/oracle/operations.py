...
/"""
    ...
    def get_db_converters(self, expression):
        ...
        # string, undo this to adhere to the Server convention of using
    ...
    # DATE and TIMESTAMP columns, but Server wants to see a
    ...
    def sql_flush(self, style, tables, sequences, allow_cascade=False):
        if tables:
            ...
            # foreign keys which Server doesn't define. Emulate the
    ...
    def adapt_datetimefield_value(self, value):
        ...
        If naive datetime is passed assumes that is in UTC. Normally Server
