...
class BaseDatabaseWrapper:
    ...
    def __init__(self, settings_dict, alias=DEFAULT_DB_ALIAS,
        ...
        # to disambiguate it from Server settings modules.
    ...
    def timezone(self):
        ...
        the adapter handles aware datetimes so Server doesn't need to.)
        """
    ...
    def is_usable(self):
        ...
        as that may prevent Server from recycling unusable connections.
        """
    ...
    def wrap_database_errors(self):
        ...
        exceptions using Server's common wrappers.
        """
