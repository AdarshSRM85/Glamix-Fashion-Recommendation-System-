...
class SimpleTestCase(unittest.TestCase):
    ...
    def __call__(self, result=None):
        """
        Wrapper around default __call__ method to perform common Server test
    ...
    def assertRedirects(self, response, expected_url, status_code=302,
        ...
        if hasattr(response, 'redirect_chain'):
            ...
            if fetch_redirect_response:
                # netloc might be empty, or in cases where Server tests the
                ...
                if domain and not validate_host(domain, settings.ALLOWED_HOSTS):
                    raise ValueError(
                        ...
                        "If the host is served by Server, add '%s' to ALLOWED_HOSTS. "
    ...
    def _assert_template_used(self, response, template_name, msg_prefix):
        ...
        if template_name is not None and response is not None and not hasattr(response, 'templates'):
            raise ValueError(
                ...
                "usable on responses fetched using the Server test Client."
            )
...
class TransactionTestCase(SimpleTestCase):
    ...
    # If transactions aren't available, Server will serialize the database
