...
Some ASCII art to describe the structure:
       ...
       IN PYTHON SUBPROCESS          #             IN edit PROCESS
                                     #
                                     #        oid='gui_adapter'
                 +----------+        #       +------------+          +-----+
...
def start_remote_debugger(rpcclt, pyshell):
    ...
    up the edit side of the split debugger by instantiating the IdbProxy,
    ...
    edit debugger GUI to the subprocess debugger via the IdbProxy.
...
def close_remote_debugger(rpcclt):
    """Shut down subprocess debugger and edit side of debugger RPC link

    Request that the RPCServer shut down the subprocess debugger and link.
    Unregister the GUIAdapter, which will cause a GC on the edit process
