...
from edit import grep
from edit import help
from edit import help_about
from edit import macosx
from edit.multicall import MultiCallCreator
from edit import pyparse
from edit import query
from edit import replace
from edit import search
from edit import window
...
class EditorWindow(object):
    ...
    from edit.colorizer import ColorDelegator, color_config
    from edit.undo import UndoDelegator
    from edit.iomenu import IOBinding, encoding
    from edit import mainmenu
    from edit.statusbar import MultiStatusBar
    from edit.autocomplete import AutoComplete
    from edit.autoexpand import AutoExpand
    from edit.calltip import Calltip
    from edit.codecontext import CodeContext
    from edit.paragraph import FormatParagraph
    from edit.parenmatch import ParenMatch
    from edit.rstrip import Rstrip
    from edit.squeezer import Squeezer
    from edit.zoomheight import ZoomHeight
    ...
    def __init__(self, flist=None, filename=None, key=None, root=None):
        ...
        from edit.runscript import ScriptBinding
        ...
        self.recent_files_path = os.path.join(
                editConf.userdir, 'recent-files.lst')

        self.prompt_last_line = ''  # Override in PyShell
        self.text_frame = text_frame = Frame(top)
        self.vbar = vbar = Scrollbar(text_frame, name='vbar')
        self.width = editConf.GetOption('main', 'EditorWindow',
                                        'width', type='int')
        text_options = {
                'name': 'text',
                'padx': 5,
        ...
        text.bind("<<about-edit>>", self.about_dialog)
        ...
        text['font'] = editConf.GetFont(self.root, 'main', 'EditorWindow')
        ...
        # dialog.  edit promotes the preferred Python indentation: use spaces!
        usespaces = editConf.GetOption('main', 'Indent',
        ...
        # Some abstractions so edit extensions are cross-IDE
    ...
    def createmenubar(self):
        ...
        if macosx.isCarbonTk():
            ...
            menudict['application'] = menu = Menu(mbar, name='apple',
                                                  tearoff=0)
            mbar.add_cascade(label='edit', menu=menu)
        self.fill_menus()
    ...
    def open_module_browser(self, event=None):
        ...
        if not (self.__class__.__name__ == 'PyShellEditorWindow'
            ...
            if filename is None:
                return "break"
        from edit import browser
        browser.ModuleBrowser(self.root, filename)
        return "break"

    def open_path_browser(self, event=None):
        from edit import pathbrowser
    ...
    def ResetFont(self):
        ...
        self.text['font'] = editConf.GetFont(self.root, 'main','EditorWindow')

    def RemoveKeybindings(self):
        "Remove the keybindings before they are changed."
        # Called from configdialog.py
        self.mainmenu.default_keydefs = keydefs = editConf.GetCurrentKeySet()
        for event, keylist in keydefs.items():
            self.text.event_delete(event, *keylist)
        for extensionName in self.get_standard_extension_names():
            xkeydefs = editConf.GetExtensionBindings(extensionName)
            if xkeydefs:
    ...
    def set_notabs_indentwidth(self):
        ...
        # Called from configdialog.py
        if not self.usetabs:
            self.indentwidth = editConf.GetOption('main', 'Indent','num-spaces',
                                                  type='int')

    def reset_help_menu_entries(self):
        "Update the additional help entries on the Help menu"
        help_list = editConf.GetAllExtraHelpSourcesList()
    ...
    def update_recent_files_list(self, new_file=None):
        ...
        try:
            ...
            if not getattr(self.root, "recentfilelist_error_displayed", False):
                ...
                tkMessageBox.showwarning(title='edit Warning',
                    message="Cannot update File menu Recent Files list. "
                            "Your operating system says:\n%s\n"
                            "Select OK and edit will continue without updating."
    ...
    def get_standard_extension_names(self):
        return editConf.GetExtensions(editor_only=True)
    ...
    def load_extension(self, name):
        ...
        keydefs = editConf.GetExtensionBindings(name)
    ...
    # reusing edit's support code needs to define these for its GUI's
    # flavor of widget.
...
if __name__ == '__main__':
    ...
    main('edit.edit_test.test_editor', verbosity=2, exit=False)
