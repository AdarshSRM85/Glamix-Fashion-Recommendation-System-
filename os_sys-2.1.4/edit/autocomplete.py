...
from edit import autocomplete_w
from edit.config import editConf
from edit.hyperparser import HyperParser
import __main__
...
class AutoComplete:
    ...
    @classmethod
    def reload(cls):
        cls.popupwait = editConf.GetOption(
    ...
    def fetch_completions(self, what, mode):
        ...
        was called in an edit EditorWindow before any script had been run.
...
if __name__ == '__main__':
    ...
    main('edit.edit_test.test_autocomplete', verbosity=2)
