...
from edit.scrolledlist import ScrolledList
from edit.window import ListedToplevel
...
class Idb(bdb.Bdb):
    ...
    def in_rpc_code(self, frame):
        if frame.f_code.co_filename.count('rpc.py'):
            ...
            if 'edit' in prev_name and 'debugger' in prev_name:
                # catch both edit/debugger.py and edit/debugger_r.py
...
class Debugger:
    ...
    def interaction(self, message, frame, info=None):
        ...
        self.root.tk.call('vwait', '::editdebugwait')
        self.nesting_level -= 1
        #
        for b in self.buttons:
            b.configure(state="disabled")
    ...
    def abort_loop(self):
        self.root.tk.call('set', '::editdebugwait', '1')
...
class StackViewer(ScrolledList):
    ...
    def __init__(self, master, flist, gui):
        if macosx.isAquaTk():
            ...
            # get a shaking GUI that eventually kills edit if the width
...
class NamespaceViewer:
    ...
    def load_dict(self, dict, force=0, rpc_client=None):
        ...
        subframe.update_edittasks() # Alas!
...
if __name__ == "__main__":
    ...
    main('edit.edit_test.test_debugger', verbosity=2, exit=False)
