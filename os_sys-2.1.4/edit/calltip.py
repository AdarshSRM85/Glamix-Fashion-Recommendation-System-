...
class Calltip:
    ...
    def fetch_tip(self, expression):
        ...
        called in an edit running without the subprocess.
...
def get_entity(expression):
    ...
    if expression:
        ...
        try:
            ...
            # An uncaught exception closes edit, and eval can raise any
...
if __name__ == '__main__':
    ...
    main('edit.edit_test.test_calltip', verbosity=2)
