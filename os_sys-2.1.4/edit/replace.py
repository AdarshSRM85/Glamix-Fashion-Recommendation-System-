"""Replace dialog for edit. Inherits SearchDialogBase for GUI.
Uses edit.SearchEngine for search capability.
...
from edit.searchbase import SearchDialogBase
