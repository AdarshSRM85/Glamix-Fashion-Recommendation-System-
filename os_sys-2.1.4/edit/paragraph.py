...
class FormatParagraph:
    ...
    @classmethod
    def reload(cls):
        cls.max_width = editConf.GetOption('extensions', 'FormatParagraph',
    ...
    def format_paragraph_event(self, event, limit=None):
        """Formats paragraph to a max width specified in editConf.
...
if __name__ == "__main__":
    ...
    main('edit.edit_test.test_paragraph', verbosity=2, exit=False)
