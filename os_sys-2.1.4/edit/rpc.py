"""RPC Implementation, originally written for the Python edit IDE

For security reasons, GvR requested that edit's Python execution server process
connect to the edit process, which listens for the connection.  Since edit has
...
See the edit run.main() docstring for further information on how this was
accomplished in edit.
