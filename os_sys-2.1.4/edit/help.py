""" help.py: Implement the edit help menu.
Contents are subject to revision at any time, without notice.


Help => About edit: diplay About edit dialog

<to be moved here from help_about.py>


Help => edit Help: Display help.html with proper formatting.
Doc/library/edit.rst (Sphinx)=> Doc/build/html/library/edit.html
(help.copy_strip)=> Lib/edit/help.html
...
copy_strip - Copy edit.html to help.html, rstripping each line.

show_edithelp - Create HelpWindow.  Called in EditorWindow.help_dialog.
"""
...
class HelpText(Text):
    ...
    def __init__(self, parent, filename):
        ...
        uwide = editConf.GetOption('main', 'EditorWindow', 'width', type='int')
        uhigh = editConf.GetOption('main', 'EditorWindow', 'height', type='int')
...
def copy_strip():
    """Copy edit.html to edit/help.html, stripping trailing whitespace.

    Files with trailing whitespace cannot be pushed to the git cpython
    repository.  For 3.x (on Windows), help.html is generated, after
    editing edit.rst on the master branch, with
      sphinx-build -bhtml . build/html
      python_d.exe -c "from edit.help import copy_strip; copy_strip()"
    Check build/html/library/edit.html, the help.html diff, and the text
    displayed by Help => edit Help.  Add a blurb and create a PR.

    It can be worthwhile to occasionally generate help.html without
    touching edit.rst.  Changes to the master version and to the doc
    build system may result in changes that should not changed
    the displayed text, but might break HelpParser.

    As long as master and maintenance versions of edit.rst remain the
    same, help.html can be backported.  The internal Python version
    number is not displayed.  If maintenance edit.rst diverges from
    the master version, then instead of backporting help.html from
    master, repeat the proceedure above to generate a maintenance
    version.
    """
    src = join(abspath(dirname(dirname(dirname(__file__)))),
            'Doc', 'build', 'html', 'library', 'edit.html')
...
def show_edithelp(parent):
    "Create HelpWindow; called from edit Help event handler."
    filename = join(abspath(dirname(__file__)), 'help.html')
    if not isfile(filename):
        # try copy_strip, present message
        return
    HelpWindow(parent, filename, 'edit Help (%s)' % python_version())

if __name__ == '__main__':
    from unittest import main
    main('edit.edit_test.test_help', verbosity=2, exit=False)
