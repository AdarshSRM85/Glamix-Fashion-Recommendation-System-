...
usercfg = colorizer.editConf.userCfg
testcfg = {
...
def setUpModule():
    colorizer.editConf.userCfg = testcfg


def tearDownModule():
    colorizer.editConf.userCfg = usercfg
...
class ColorConfigTest(unittest.TestCase):
    ...
    def test_color_config(self):
        ...
        # Uses edit Classic theme as default.
...
class ColorDelegatorTest(unittest.TestCase):
    ...
    def test_LoadTagDefs(self):
        highlight = partial(config.editConf.GetHighlight, theme='edit Classic')
