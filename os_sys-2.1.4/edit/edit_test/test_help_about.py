...
from edit.edit_test.mock_tk import Mbox_func
...
class LiveDialogTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.root = Tk()
        cls.root.withdraw()
        cls.dialog = About(cls.root, 'About edit', _utest=True)
    ...
    def test_file_buttons(self):
        ...
        button_sources = [(self.dialog.readme, 'README.txt', 'readme'),
                          (self.dialog.edit_news, 'NEWS.txt', 'news'),
                          (self.dialog.edit_credits, 'CREDITS.txt', 'credits')]

        for button, filename, name in button_sources:
            with  self.subTest(name=name):
                button.invoke()
                fn = findfile(filename, subdir='edit')
                get = dialog._current_textview.viewframe.textframe.text.get
...
class Dummy_about_dialog():
    ...
    edit_credits = About.show_edit_credits
    edit_readme = About.show_readme
    edit_news = About.show_edit_news
    # Called by the above
...
class DisplayFileTest(unittest.TestCase):
    ...
    def test_file_display(self):
        for handler in (self.dialog.edit_credits,
                        self.dialog.edit_readme,
                        self.dialog.edit_news):
            self.error.message = ''
