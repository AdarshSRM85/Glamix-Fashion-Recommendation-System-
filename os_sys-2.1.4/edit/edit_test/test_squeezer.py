...
from edit.squeezer import count_lines_with_wrapping, ExpandingButton, \
    Squeezer
from edit import macosx
from edit.textview import view_text
from edit.tooltip import Hovertip
from edit.pyshell import PyShell
...
class SqueezerTest(unittest.TestCase):
    ...
    def set_editconf_option_with_cleanup(self, configType, section, option, value):
        prev_val = editConf.GetOption(configType, section, option)
        editConf.SetOption(configType, section, option, value)
        self.addCleanup(editConf.SetOption,
    ...
    def test_reload(self):
        ...
        self.set_editconf_option_with_cleanup(
...
class ExpandingButtonTest(unittest.TestCase):
    ...
    @patch('edit.squeezer.Hovertip', autospec=Hovertip)
    ...
    def test_expand_dangerous_oupput(self):
        ...
        with patch('edit.squeezer.tkMessageBox') as mock_msgbox:
    ...
    def test_view(self):
        ...
        with patch('edit.squeezer.view_text', autospec=view_text)\
                as mock_view_text:
