'''Run human tests of edit's window, dialog, and popup widgets.
...
import edit.pyshell  # Set Windows DPI awareness before Tk().
...
AboutDialog_spec = {
    ...
    'msg': "Test every button. Ensure Python, TK and edit versions "
...
_color_delegator_spec = {
    ...
    'msg': "The text is sample Python code.\n"
           ...
           "The default color scheme is in edit/config-highlight.def"
    }
...
_multi_call_spec = {
    'file': 'multicall',
    'kwds': {},
    'msg': "The following actions should trigger a print to console or edit"
...
_percolator_spec = {
    ...
    'msg': "There are two tracers which can be toggled using a checkbox.\n"
           ...
           "output to the console or to the edit shell.\n"
...
_scrolled_list_spec = {
    ...
    'msg': "You should see a scrollable list of items\n"
           ...
           "prints the name to the console or edit shell.\n"
...
_undo_delegator_spec = {
    ...
    'msg': "Click [Undo] to undo any action.\n"
           ...
           "by printing to the console or the edit shell.\n"
    }
    ...
    if tests:
        ...
        for k, d in globals().items():
            if k.endswith('_spec'):
                ...
                mod = import_module('edit.' + test_spec['file'])
