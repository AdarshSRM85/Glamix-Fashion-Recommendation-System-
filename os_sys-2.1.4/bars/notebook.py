...
Usage:
  >>> from bars.notebook import brange[, bars]
...
# to inherit from the bars class
from .std import bars as std_bars
...
__all__ = ['bars_notebook', 'tnrange', 'bars', 'brange']


class bars_notebook(std_bars):
    """
    Experimental IPython/Jupyter Notebook widget using bars!
    """
    ...
    def status_printer(_, total=None, desc=None, ncols=None):
        ...
        # if not total:
        #    return super(bars_notebook, bars_notebook).status_printer(file)
        ...
        try:
            ...
            else:  # No total? Show info style bar with no progress bars status
    ...
    def display(self, msg=None, pos=None,
        ...
        # Note: conbrary to native bars, msg='' does NOT clear bar
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(bars_notebook, self).__init__(*args, **kwargs)
    ...
    def __iter__(self, *args, **kwargs):
        try:
            for obj in super(bars_notebook, self).__iter__(*args, **kwargs):
                # return super(bars...) will not catch exception
                yield obj
    ...
    def update(self, *args, **kwargs):
        try:
            super(bars_notebook, self).update(*args, **kwargs)
        except Exception as exc:
            # cannot catch KeyboardInterrupt when using manual bars
            # as the interrupt will most likely happen on another statement
            self.sp(bar_style='danger')
            raise exc

    def close(self, *args, **kwargs):
        super(bars_notebook, self).close(*args, **kwargs)
...
def tnrange(*args, **kwargs):
    ...
    """
    return bars_notebook(_range(*args), **kwargs)
